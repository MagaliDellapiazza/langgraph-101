...
from chains.binary_questions import BINARY_QUESTION_CHAIN # Binary Question Addition
...
# binary question addition - start -
...
workflow.add_node("answer_follow_up_question", answer_follow_up_question_node) # addition Binary Question (Conditional Edges)
