...
from graphs.notice_extraction_binary import NOTICE_EXTRACTION_GRAPH # we call _binary as it is the last implementation (complete) of notice_extraction
...
EMAIL_AGENT_MODEL = ChatOpenAI(model="gpt-4o-mini", temperature=0,  base_url="https://openrouter.ai/api/v1", api_key=os.getenv("OPENROUTER_API_KEY")).bind_tools(
    tools
)
